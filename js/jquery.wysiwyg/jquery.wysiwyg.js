...
(function( $ )
{
	...
	var iFrameHtml = ""
	    if($.browser.msie)
	    {
	    	...
	    	iFrameHtml = '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head>STYLE_SHEET</head><body style="max-width: 95%; padding: 0px 5px; overflow-x: hidden; overflow-y: auto; margin: 0; font-family: Arial, Helvetica, sans-serif !important; font-size: 13px; line-height: 1.5em; height: 100%; background: #fff;">INITIAL_CONTENT</body></html>'

	    }
	    else
	    {
	
		iFrameHtml =  '<'+'?xml version="1.0" encoding="UTF-8"?'+'><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">STYLE_SHEET</head><body style="max-width: 95%; padding: 0px 5px; overflow-x: hidden; overflow-y: auto; margin: 0; font-family: Arial, Helvetica, sans-serif !important; font-size: 13px; height: 100%; line-height: 1.5em !important;">INITIAL_CONTENT</body></html>';
	    }
        var options = $.extend({
