<?php $this->beginContent('dashboard'); ?>
    <div class="row-fluid">
        <div>
         <?php $this->widget('bootstrap.widgets.TbButtonGroup', array(
            ...
            'buttons'=>array(
                ...
                array('label'=>'', 'url'=>$this->createUrl('/admin/content/perspective?id=2'), 'icon' => 'th-list', 'htmlOptions' => array('class'=>Yii::app()->session['admin_perspective'] == 2 ? 'active' : NULL)),
