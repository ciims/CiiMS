				...
				<div class="content">
					...
					$this->widget('zii.widgets.CMenu', array(
						...
						'items' => array(
							...
							array('url' => $this->createUrl('/dashboard/settings/appearance'), Yii::t('Dashboard.views', 'label' => 'Appearance'), 'itemOptions' => array('class' => 'icon-eye-open'), 'active' => ($this->id == 'settings' && $this->action->id == 'appearance' ? true : false)),
