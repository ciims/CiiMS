...
class CiiInflector
{
    ...
    public static function titleize($word, $uppercase = '')
    {
        ...
        return $uppercase(CiiInflector::humanize(CiiInflector::underscore($word)));
    }
    ...
    {
        return ucwords(str_replace("_", " ", CiiInflector::underscore($word)));
    }
    ...
    */
    ...
    {
        $word = CiiInflector::camelize($word);
    ...
    {
        return CiiInflector::pluralize(CiiInflector::underscore($class_name));
    }
