...
/**
 * YiiRedsCache implements a cache application component based on {@link http://redis.io/ redis}.
 *
 * YiiRedsCache needs to be configured with {@link hostname}, {@link port} and {@link database} of the server
 * to connect to. By default YiiRedsCache assumes there is a redis server running on localhost at
 * port 6379 and uses the database number 0.
 *
 * YiiRedsCache also supports {@link http://redis.io/commands/auth the AUTH command} of redis.
 * When the server needs authentication, you can set the {@link password} property to
 * authenticate with the server after connect.
 *
 * See {@link CCache} manual for common cache operations that are supported by YiiRedsCache.
 *
 * To use YiiRedsCache as the cache application component, configure the application as follows,
 * <pre>
 * array(
 *     'components'=>array(
 *         'cache'=>array(
 ...
 * @since 1.1.14
 */
class YiiRedsCache extends CiiCache
{
        /**
