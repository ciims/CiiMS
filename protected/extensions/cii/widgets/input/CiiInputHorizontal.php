...
Yii::import('cii.widgets.input.CiiInput');

/**
 * Bootstrap horizontal form input widget.
 * @since 0.9.8
 */
class CiiInputHorizontal extends CiiInput
{
	/**
	 * Runs the widget.
	 */
	...
	protected function toggleButton()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('bootstrap.widgets.CiiToggleButton', $options);
		echo $this->getError() . $this->getHint();
		echo '</div>';
	}
	...
	protected function datepickerField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('bootstrap.widgets.CiiDatePicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
	...
	protected function colorpickerField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('bootstrap.widgets.CiiColorPicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'format' => $format,
			'events' => isset($events) ? $events : array(),
	...
	protected function redactorJs()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('bootstrap.widgets.CiiRedactorJs', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
	...
	protected function markdownEditorJs()
	{
		...
		$this->widget('bootstrap.widgets.CiiMarkdownEditorJs', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'width' => isset($width) ? $width : '100%',
			'height' => isset($height) ? $height : '400px',
	...
	protected function html5Editor()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('bootstrap.widgets.CiiHtml5Editor', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'editorOptions' => isset($options) ? $options : array(),
			'width' => isset($width) ? $width : '100%',
	...
	protected function ckEditor()
	{
		...
		echo $this->getLabel();
		echo '<div class="controls">';
		$this->widget('bootstrap.widgets.CiiCKEditor', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'editorOptions' => isset($options) ? $options : array(),
			'htmlOptions' => $this->htmlOptions
	...
	protected function dateRangeField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('bootstrap.widgets.CiiDateRangePicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'options' => isset($options) ? $options : array(),
	...
	protected function timepickerField()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('bootstrap.widgets.CiiTimePicker', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'options' => isset($options) ? $options : array(),
			'events' => isset($events) ? $events : array(),
	...
	protected function select2Field()
	{
		...
		echo '<div class="controls">';
		echo $this->getPrepend();
		$this->widget('bootstrap.widgets.CiiSelect2', array(
			'model' => $this->model,
			'attribute' => $this->attribute,
			'options' => isset($options) ? $options : array(),
			'events' => isset($events) ? $events : array(),
