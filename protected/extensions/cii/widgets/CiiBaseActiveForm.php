 ...
 */
class CiiBaseActiveForm extends CActiveForm
{
	// Form types.
	...
	// Input classes.
	const INPUT_HORIZONTAL = 'cii.widgets.input.CiiInputHorizontal';
	const INPUT_INLINE = 'cii.widgets.input.CiiInputInline';
	const INPUT_SEARCH = 'cii.widgets.input.CiiInputSearch';
	const INPUT_VERTICAL = 'cii.widgets.input.CiiInputVertical';
	...
	*/
	...
	{
		return $this->inputRow(CiiInput::TYPE_DATERANGEPICKER, $model, $attribute, null, $htmlOptions);
	}
	...
	public function radioButtonGroupsList($model, $attribute, $data, $htmlOptions = array())
	{
		...
		Yii::app()->controller->widget('bootstrap.widgets.CiiButtonGroup', array(
			'buttonType' => 'button',
			'toggle' => 'radio',
