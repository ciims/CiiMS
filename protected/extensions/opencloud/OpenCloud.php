...
// Import OpenCloud\ namespace
require Yii::getPathOfAlias('ext.opencloud.vendor.autoload') . '.php';
Yii::setPathOfAlias('OpenCloud', Yii::getPathOfAlias('ext.opencloud.lib.opencloud'));

/**
 * OpenCloud Component
 * Assists in managing OpenCloud Resources (namely)
 */
class OpenCloud extends CComponent
{
	// Identity URL
	...
	{
		$this->_service = $this->client->objectStoreService('cloudFiles', $this->region);
	...
	public function getContainer($name=NULL)
	{
		...
		$this->getService();
        $this->_container = $this->service->getContainer($name);
