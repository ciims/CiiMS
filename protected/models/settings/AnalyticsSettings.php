...
class AnalyticsSettings extends CiiSettingsModel
{
	...
	{
		return array(
			'analyticsjs_AdRoll_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_AdRoll_advId' => 'advId',
			'analyticsjs_AdRoll_pixId' => 'pixId',

			'analyticsjs_Amplitude_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Amplitude_apiKey' => Yii::t('ciims.models.analytics', 'API Key'),
			'analyticsjs_Amplitude_pageview' => 'pageview',

			'analyticsjs_BugHerd_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_BugHerd_apiKey' => Yii::t('ciims.models.analytics', 'API Key'),
			'analyticsjs_BugHerd_showFeedbackTab' => 'showFeedbackTab',

			'analyticsjs_Chartbeat_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Chartbeat_domain' => Yii::t('ciims.models.analytics', 'Domain'),
			'analyticsjs_Chartbeat_uid' => Yii::t('ciims.models.analytics', 'UID'),

			'analyticsjs_ClickTale_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			...
			'analyticsjs_Clicky_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Clicky_siteId' => Yii::t('ciims.models.analytics', 'Site ID'),

			'analyticsjs_comScore_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_comScore_c1' => 'c1',
			'analyticsjs_comScore_c2' => 'c2',

			'analyticsjs_CrazyEgg_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_CrazyEgg_accountNumber' => 'accountNumber',

			'analyticsjs_Customer___io_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Customer___io_siteId' => 'siteId',

			'analyticsjs_Errorception_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Errorception_projectId' => Yii::t('ciims.models.analytics', 'Project ID'),
			'analyticsjs_Errorception_meta' => Yii::t('ciims.models.analytics', 'Meta'),

			'analyticsjs_FoxMetrics_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_FoxMetrics_appId' => 'appId',

			'analyticsjs_Gauges_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Gauges_siteId' => Yii::t('ciims.models.analytics', 'Site ID'),

			'analyticsjs_Get__Satisfaction_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			...
			'analyticsjs_Google__Analytics_anonymizeIp' => Yii::t('ciims.models.analytics', 'Anonymize IP?'),
			'analyticsjs_Google__Analytics_domain' => Yii::t('ciims.models.analytics', 'Domain'),
			'analyticsjs_Google__Analytics_doubleClick' => Yii::t('ciims.models.analytics', 'Double Click?'),
			'analyticsjs_Google__Analytics_enhancedLinkAttribution' => Yii::t('ciims.models.analytics', 'Enable Enhanced Link Attribution?'),
			'analyticsjs_Google__Analytics_ignoreReferrer' => Yii::t('ciims.models.analytics', 'Ignore Referrer?'),
			'analyticsjs_Google__Analytics_initialPageview' => Yii::t('ciims.models.analytics', 'Track Initial Pageview?'),
			'analyticsjs_Google__Analytics_siteSpeedSampleRate' => Yii::t('ciims.models.analytics', 'Site Speed Sample Rate'),
			...
			'analyticsjs_GoSquared_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_GoSquared_siteToken' => Yii::t('ciims.models.analytics', 'Site Token'),

			'analyticsjs_Heap_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Heap_apiKey' => Yii::t('ciims.models.analytics', 'API Key'),

			'analyticsjs_HitTail_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_HitTail_siteId' => 'siteId',

			'analyticsjs_HubSpot_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_HubSpot_portalId' => 'portalId',

			'analyticsjs_Improvely_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Improvely_domain' => 'domain',

			'analyticsjs_Improvely_projectId' => 'projectId',

			'analyticsjs_Intercom_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Intercom_appId' => 'appId',
			'analyticsjs_Intercom_activator' => 'activator',
			'analyticsjs_Intercom_counter' => 'counter',

			'analyticsjs_Keen__IO_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			...
			'analyticsjs_KISSmetrics_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_KISSmetrics_apiKey' => Yii::t('ciims.models.analytics', 'API Key'),

			'analyticsjs_Klaviyo_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Klaviyo_apiKey' => Yii::t('ciims.models.analytics', 'API Key'),

			'analyticsjs_LiveChat_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_LiveChat_license' => 'license',

			'analyticsjs_Lytics_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Lytics_cid' => 'cid',

			'analyticsjs_Mixpanel_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			...
			'analyticsjs_Olark_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			...
			'analyticsjs_Optimizely_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Optimizely_variations' => 'variations',

			'analyticsjs_Perfect__Audience_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			...
			'analyticsjs_Qualaroo_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Qualaroo_customerId' => 'customerId',
			'analyticsjs_Qualaroo_siteToken' => 'siteToken',
			'analyticsjs_Qualaroo_track' => 'track',
			'analyticsjs_Quantcast_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Quantcast_pCode' => 'pCode',

			'analyticsjs_Sentry_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Sentry_config' => Yii::t('ciims.models.analytics', 'Config'),

			'analyticsjs_SnapEngage_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_SnapEngage_apiKey' => Yii::t('ciims.models.analytics', 'API Key'),

			'analyticsjs_USERcycle_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_USERcycle_key' => 'key',

			'analyticsjs_userfox_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_userfox_clientId' => 'clientId',
			'analyticsjs_UserVoice_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			...
			'analyticsjs_Vero_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Vero_apiKey' => Yii::t('ciims.models.analytics', 'API Key'),

			'analyticsjs_Visual__Website__Optimizer_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
			'analyticsjs_Visual__Website__Optimizer_replay' => 'replay',

			'analyticsjs_Woopra_enabled' => Yii::t('ciims.models.analytics', 'Enabled'),
